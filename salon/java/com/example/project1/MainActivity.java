...
public class MainActivity extends AppCompatActivity
{
    ...
    DatabaseReference rreference,reference2;
    Customer ccustomer;
    long bbackpress;
    Toast bbackToast;
                        ...
                        query.addListenerForSingleValueEvent(new ValueEventListener()
                        {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                            {
                                ...
                                else
                                {
                                    ...
                                    eepasswoed.setText("");
                                    eephoneNo.setText("");  */
                                    reference2= FirebaseDatabase.getInstance().getReference().child("Customer").child(sphoneno);

                                    customer.setName(sname);
                                    customer.setMobileNum(sphoneno);
                                    customer.setPassword(spassword);

                                    reference2.setValue(customer).addOnSuccessListener(new OnSuccessListener<Void>()
                                    {
                                        @Override
